...
export const quicksData = [
  {
    ...
    author: 'Ms. Kavita & SyncBuddy',
    caption: 'Discover delicious, healthy fruits like Mangoes, Apples, and Bananas with fun rhymes!',
    likes: 2450,
    isLiked: false,
    isSaved: false,
  ...
  },
  {
    ...
    caption: 'Learn degrees of comparison: -er vs -est adjectives with clear visual sizing!',
    likes: 3120,
    isLiked: false,
    isSaved: false,
    quizTarget: 'lang-01',
  ...
  },
  {
    ...
    caption: 'Less than 90° is Acute (sharp & cute!). Exactly 90° makes a perfect square corner.',
    likes: 1840,
    isLiked: false,
    isSaved: false,
    quizTarget: 'math-03',
