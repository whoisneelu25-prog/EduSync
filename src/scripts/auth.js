...
const DEMO_GOOGLE_ACCOUNTS = [
  {
    ...
    preferredTeacher: 'priya'
  },
  {
    uid: 'google_user_diya_2026',
    name: 'Diya Patel',
    ...
    savedReels: ['angles'],
    preferredTeacher: 'rohan'
  },
  {
    uid: 'google_user_meera_2026',
    name: 'Meera Sharma',
    email: 'meera.sharma.parent@gmail.com',
